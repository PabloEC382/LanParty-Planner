...
/// Interface de repositório para a entidade Event.
///
...
/// - Certifique-se de que a entidade Event possui métodos de conversão robustos (ex: aceitar id como int ou string, datas como DateTime ou String).
...
/// - Consulte os arquivos de debug do projeto (ex: events_cache_debug_prompt.md, supabase_init_debug_prompt.md, supabase_rls_remediation.md) para exemplos de logs, prints e soluções de problemas reais.
abstract class EventsRepository {
  ...
  Future<List<Event>> loadFromCache();
  ...
  /// Este método retorna todos os eventos disponíveis no cache.
  /// Boas práticas:
  ...
  /// Este método retorna apenas os eventos destacados/em destaque.
  /// Boas práticas:
  /// - Assegure-se de que a entidade Event possui um campo para marcar eventos em destaque.
  /// - Use este método para exibir seções especiais na UI (ex: "Eventos em Destaque").
  ...
  /// Este método busca um evento específico pelo seu ID.
  /// Boas práticas:
  /// - Verifique se o cache contém o ID antes de fazer requisições remotas.
  /// - Retorne null se o evento não for encontrado no cache.
...
/*
// Exemplo de uso:
final repo = MinhaImplementacaoDeEventsRepository();
